...
//|dof_exec_for_each_files     | -       | v      | no  |
//|dof_exec_for_each_paths     | -       | v      | no  |
//|dof_run_for_files           | v       | -      | --  |
//|dof_run_for_paths           | v       | -      | --  |
//|dof_run_for_src_dst_files   | v       | -      | --  |
//|dof_run_for_src_dst_paths   | v       | -      | --  |
//|dof_run_for_symlink         | v       | -      | --  |
//|dof_run_command_immediate   | --      | --     | yes |
//|doe_run_line_immediate      | --      | --     | yes |
