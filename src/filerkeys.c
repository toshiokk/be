...
// 123456789,123456789,123456789,123456789     123456789012345678901234567890
 ...
 {EFAM, "Page up  ",             "Page UP",
  {K_C_r    ,K_PPAGE  ,K_C_s    ,K_LEFT   },F_I(dof_page_up),             get_str_none },
 {EFAM, "Page down",             "Page DOWN",
  {K_C_c    ,K_NPAGE  ,K_C_d    ,K_RIGHT  },F_I(dof_page_down),           get_str_none },
 ...
 {EFAM, "Edit ",                 "Edit file (project file)",
  {K_e_     ,K_F11    ,KNA      ,KNA      },F_I(dof_open_file_recursive), get_str_none },
 {EFAM, "View File",             "View file (Read-Only)",
  {K_E_     ,KNA      ,KNA      ,KNA      },F_I(dof_open_file_ro),        get_str_none },
 {EFAM, "Edit ",                 "Edit file",
  {K_M_e    ,K_F12    ,KNA      ,KNA      },F_I(dof_open_file_non_recursive),get_str_none },
 {EFAM, "Edit ",                 "Edit file",
  {K_M_E    ,KNA      ,KNA      ,KNA      },F_I(dof_open_file_from_history),get_str_none },
 {EFNM, "Open locked file",      "Open locked file",
  {K_MC_e   ,KNA      ,KNA      ,KNA      },F_I(dof_open_file_locked),    get_str_none },
 ...
 {EFNM, "Real path",             "Convert Symlink to Real path",
  {K_M_L    ,KNA      ,KNA      ,KNA      },F_I(dof_real_path),           get_str_none },
