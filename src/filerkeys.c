...
// 123456789,123456789,123456789      123456789012345678901234567890
 {EFNM, "Menu",                "Previous Menu",
  {K_ESC    ,KNA      ,KNA      },F_I(dof_menu_0),                     get_str_setting_none },
 {EFLM, "Menu",                "Previous Menu",
  {K_ESC    ,KNA      ,KNA      },F_I(dof_quit),                       get_str_setting_none },

 {EFNM, "",                    "Filer Editor Menu",
  {KNA      ,KNA      ,KNA      },F_I(dof_menu_0),                     get_str_setting_none },
 {EFAM, "Quit",                "Quit filer",
  {K_q_     ,KNA      ,KNA      },F_I(dof_quit),                       get_str_setting_none },
 {EFAM, "Quit",                "Quit filer",
  {K_C_q    ,K_M_q    ,KNA      },F_I(dof_quit_soon),                  get_str_setting_none },
 ...
 {EFAM, "Edit ",               "Edit file (project file)",
  {K_e_     ,KNA      ,K_F01    },F_I(dof_open_file_recursive),        get_str_setting_none },
 {EFAM, "View File",           "View file (Read-Only)",
  {K_E_     ,KNA      ,KNA      },F_I(dof_open_file_ro),               get_str_setting_none },
 {EFAM, "Edit ",               "Edit file",
  {K_M_e    ,KNA      ,K_F02    },F_I(dof_open_file_non_recursive),    get_str_setting_none },
 {EFAM, "Edit ",               "Edit file",
 ...
 {EFLM, "EntFN",               "Enter cur file name",
  {K_n_     ,KNA      ,KNA      },F_I(dof_enter_file_name),            get_str_setting_none },
 {EFLM, "EntFN",               "Enter cur file name",
  {K_M_n    ,KNA      ,KNA      },F_I(dof_enter_file_name_add),        get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
  {K_N_     ,KNA      ,KNA      },F_I(dof_enter_file_path),            get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
  {K_M_N    ,KNA      ,KNA      },F_I(dof_enter_file_path_add),        get_str_setting_none },
 ...
 {EFNM, "",                    "Filer File Menu",
  {KNA      ,KNA      ,KNA      },F_I(dof_menu_0),                     get_str_setting_none },
 {EFNM, "Copy ",               "Copy file",
  {K_c_     ,K_M_c    ,K_F03    },F_I(dof_copy_file),                  get_str_setting_none },
 {EFNM, "CpUpd",               "Copy file update",
  {K_C_     ,KNA      ,K_S_F03  },F_I(dof_copy_file_update),           get_str_setting_none },
 {EFNM, "Drop to Copy",        "Drop to Copy file",
  {K_M_C    ,KNA      ,KNA      },F_I(dof_drop_files_to_copy),         get_str_setting_none },
 {EFNM, "Move ",               "Move file",
  {K_m_     ,K_M_m    ,K_F04    },F_I(dof_move_file),                  get_str_setting_none },
 {EFNM, "MvUpd",               "Move file update",
  {K_M_     ,KNA      ,K_S_F04  },F_I(dof_move_file_update),           get_str_setting_none },
 {EFNM, "Renam",               "Rename file",
  {K_n_     ,K_N_     ,K_F05    },F_I(dof_rename_file),                get_str_setting_none },
 {EFNM, "Drop to Move",        "Drop to Move file",
  {K_M_M    ,KNA      ,KNA      },F_I(dof_drop_files_to_move),         get_str_setting_none },
 {EFNM, "Trash",               "Trash file",
  {K_d_     ,KNA      ,K_F06    },F_I(dof_trash_file),                 get_str_setting_none },
 {EFNM, "Delet",               "Delete file",
  {K_D_     ,K_DEL    ,K_S_F06  },F_I(dof_delete_file),                get_str_setting_none },
 ...
 {EFAM, "Select all",          "Select all files",
  {K_C_a    ,KNA      ,KNA      },F_I(dof_select_all_regular_files),   get_str_setting_none },
 ...
 {EFAM, "Mkdir",               "Make directory",
  {K_k_     ,K_M_k    ,K_F07    },F_I(dof_make_directory),             get_str_setting_none },
 {EFAM, "clip file",           "Send file name to clip-board",
  {K_S_F07  ,K_M_AMPSD,KNA      },F_I(dof_clip_file),                  get_str_setting_none },
 {EFAM, "Chdir",               "Change directory",
  {K_h_     ,K_M_h    ,K_F08    },F_I(dof_change_directory),           get_str_setting_none },
 {EFAM, "clip path",           "Send file path to clip-board",
  {K_S_F08  ,K_M_ASTER,KNA      },F_I(dof_clip_path),                  get_str_setting_none },
 ...
 {EFLM, "Enter file/dir",      "Enter file/directory",
  {K_ENTER  ,KNA      ,K_F11    },F_I(dof_tap_file_to_enter),          get_str_setting_none },
 {EFLM, "Enter file/dir",      "Enter file/directory",
  {K_M_ENTER,KNA      ,K_F12    },F_I(dof_tap_file_to_enter_add),      get_str_setting_none },
 ...
 {EFNM, "Exec ",               "Execute command with file",
  {K_x_     ,KNA      ,K_F09    },F_I(dof_exec_command_with_file),     get_str_setting_none },
 ...
 {EFNM, "Run  ",               "Run command (relative path)",
  {K_r_     ,KNA      ,K_F10    },F_I(dof_run_command_rel),            get_str_setting_none },
 ...
 {EFAM, "Switch pane",         "Switch filer pane",
  {K_TAB    ,K_M_TAB  ,KNA      },F_I(dof_tog_panex),                  get_str_filer_pane_num },
 {EFAM, "Refresh",             "Refresh filer screen",
  {K_COMMA  ,K_SEMCO  ,KNA      },F_I(dof_refresh_filer),              get_str_setting_none },
