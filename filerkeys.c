...
// 123456789012345678901234
 ...
 {EFNM, "Edit ",               "Edit file (project file)",
   {K_e_, K_F11,        KNA}, F_I(dof_open_file_recursive),        get_str_setting_none },
 ...
 {EFLM, "EntFN",               "Enter cur file name",
   {K_e_, K_c_, K_n_       }, F_I(dof_enter_file_name),            get_str_setting_none },
 {EFLM, "EntFN",               "Enter cur file name",
   {K_M_e, K_M_c, K_M_n    }, F_I(dof_enter_file_name_append),     get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
   {K_E_, K_C_, K_N_       }, F_I(dof_enter_file_path),            get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
   {K_M_E, K_M_C, K_M_N    }, F_I(dof_enter_file_path_append),     get_str_setting_none },
 ...
 {EFNM, "CpUpd",               "Copy file update",
   {K_C_, K_S_F01,     KNA }, F_I(dof_copy_file_update),           get_str_setting_none },
 {EFNM, "Drop to Copy",        "Drop to Copy file",
   {K_M_C,         KNA, KNA}, F_I(dof_drop_files_to_copy),         get_str_setting_none },
 {EFNM, "Move ",               "Move file",
   {K_m_, K_F02, K_M_m     }, F_I(dof_move_file),                  get_str_setting_none },
 {EFNM, "MvUpd",               "Move file update",
   {K_M_, K_S_F02,     KNA }, F_I(dof_move_file_update),           get_str_setting_none },
 {EFNM, "Renam",               "Rename file",
   {K_n_, K_F03, K_N_      }, F_I(dof_rename_file),                get_str_setting_none },
 {EFNM, "Drop to Move",        "Drop to Move file",
   {K_M_M,         KNA, KNA}, F_I(dof_drop_files_to_move),         get_str_setting_none },
 {EFNM, "Trash",               "Trash file",
   {K_d_, K_F04,        KNA}, F_I(dof_trash_file),                 get_str_setting_none },
 {EFNM, "Delet",               "Delete file",
   {K_D_, K_S_F04, K_DEL   }, F_I(dof_delete_file),                get_str_setting_none },
 {EFNM, "MkDel",               "Mark to be Deleted",
   {K_f_, K_F05,        KNA}, F_I(dof_mark_to_delete_file),        get_str_setting_none },
 {EFNM, "Size zero",           "File size zero",
   {K_F_, K_S_F05,      KNA}, F_I(dof_size_zero_file),             get_str_setting_none },
 {EFNM, "View",                "View file",
 ...
 {EFLM, "EntDi",               "Enter current dir path",
   {K_m_, K_F02, K_M_m     }, F_I(dof_enter_dir_path),             get_str_setting_none },
 {EFLM, "EntDi",               "Enter current dir path",
   {K_M_,          KNA, KNA}, F_I(dof_enter_dir_path_append),      get_str_setting_none },
 ...
 {EFLM, "Enter file/dir",      "Enter file/directory",
   {K_M_ENTER,     KNA, KNA}, F_I(dof_tap_file_to_enter_append),   get_str_setting_none },
 ...
 {EFNM, "Execute command w/ files","Execute command with files",
   {K_X_,          KNA, KNA}, F_I(dof_exec_command_with_files),    get_str_setting_none },
 {EFAM, "Run soon w/ logging", "Run command soon w/ logging",
   {K_M_x, K_M_r,       KNA}, F_I(dof_run_command_soon_w_log),     get_str_setting_none },
 {EFAM, "Run soon",            "Run command soon",
   {K_M_X, K_M_R,       KNA}, F_I(dof_run_command_soon_wo_log),    get_str_setting_none },
 {EFNM, "Run  ",               "Run command (relative path)",
   {K_r_, K_F10,        KNA}, F_I(dof_run_command_rel),            get_str_setting_none },
 {EFNM, "Run command abs.",    "Run command (absolute path)",
   {K_R_,          KNA, KNA}, F_I(dof_run_command_abs),            get_str_setting_none },
 {EFNM, "Run command(src/dest-dir)", "Run command (src/dest dir)",
   {K_t_,          KNA, KNA}, F_I(dof_run_command_src_dst_dir),    get_str_setting_none },
 {EFNM, "Run command(src/dest-file)","Run command (src/dest file)",
 ...
 {EFAM, "Code-7F Key-BS",      "Toggle Code-7F Key-BS",
   {K_M_D, K_M_CHAR_DEL,KNA}, F_I(doe_tog_map_key_7f_bs),          get_str_map_key_7f_bs },
