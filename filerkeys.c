...
//       12345678901234567890
 ...
 { "Open new file",       "Open new file",                           K_('E'), K_M_E,    KNA,
   XF, F_I(dof_open_new_file), NULL },
 { "Open files dropped",  "Open files dropped",                      K_('\''),     KNA, KNA,
   XF, F_I(dof_open_new_file_dropped), NULL },
 ...
 { "Enter file/dir",      "Enter file/directory",                    K_MC_M,       KNA, KNA,
 ...
 { "Size zero",           "File size zero",                          K_('F'), K_S_F07,  KNA,
   XF, F_I(dof_size_zero_file), NULL },
 ...
 { "Prev Page",           "Page UP",                                 K_C_R, K_PPAGE,    KNA,
   XA, F_I(dof_page_up), NULL },
 { "Next Page",           "Page DOWN",                               K_C_C, K_NPAGE,    KNA,
 ...
 { "Execute command w/ files","Execute command with files",          K_('X'),      KNA, KNA,
   XF, F_I(dof_exec_command_with_files), NULL },
 { "Execute command w/ log","Execute command with files w/ log",     K_MC_X,       KNA, KNA,
   XF, F_I(dof_exec_command_with_files_w_log), NULL },
 { "Run soon",            "Run command soon",                        K_M_x,        KNA, KNA,
   XA, F_I(dof_run_command_soon), NULL },
 { "Run soon w/ logging", "Run command soon w/ logging",             K_M_X,        KNA, KNA,
   XA, F_I(dof_run_command_soon_w_log), NULL },
 { "Run command rel.",    "Run command (relative path)",             K_('r'),      KNA, KNA,
   XF, F_I(dof_run_command_rel), NULL },
 { "Run command rel. w/ log","Run command (rel) w/ logging",         K_('R'),      KNA, KNA,
   XF, F_I(dof_run_command_rel_w_log), NULL },
 { "Run command abs.",    "Run command (absolute path)",             K_M_r,        KNA, KNA,
   XF, F_I(dof_run_command_abs), NULL },
 { "Run command abs. w/ log","Run command (abs) w/ logging",         K_M_R,        KNA, KNA,
   XF, F_I(dof_run_command_abs_w_log), NULL },
