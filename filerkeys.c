...
// 12345678901234567890
 ...
 { EFNM_EXEC, "Restart filer",       "Restart filer",
 ...
 { F_LM_FLNM, "Open files input",    "Open files input",
 ...
 { F_LM_CUDI, "Move ",               "Move file",
   {K_M_, K_F03,       KNA}, F_I(dof_move_file_update),    get_str_setting_none },
 ...
 { EFAM_EXEC, "Unzip file",          "Unzip file",
 ...
 { F_LM_FLNM, "Run command(src/dest-dir)", "Run command (src/dest dir)",
   {K_t_,         KNA, KNA}, F_I(dof_run_command_src_dst_dir), get_str_setting_none },
 { F_LM_FLNM, "Run command(src/dest-file)","Run command (src/dest file)",
 ...
 { EFAM_EXEC, "Show zebra stripes",  "Show zebra stripes",
