...
// 123456789012345678901234
 ...
 {EFLM, "EntFN",               "Enter cur file name",
   {K_M_e, K_M_c, K_M_n    }, F_I(dof_enter_file_name_add),        get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
   {K_E_, K_C_, K_N_       }, F_I(dof_enter_file_path),            get_str_setting_none },
 {EFLM, "EntFP",               "Enter cur file path",
   {K_M_E, K_M_C, K_M_N    }, F_I(dof_enter_file_path_add),        get_str_setting_none },
 ...
 {EFLM, "EntDi",               "Enter current dir path",
   {K_M_,          KNA, KNA}, F_I(dof_enter_dir_path_add),         get_str_setting_none },
