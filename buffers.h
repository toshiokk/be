...
#define BUFVX_MIN_TEXT_X_TO_KEEP(buf, idx)	BUFV_MIN_TEXT_X_TO_KEEP(BUFVX((buf), (idx)))
...
#define BUFV0_MIN_TEXT_X_TO_KEEP(buf)		BUFVX_MIN_TEXT_X_TO_KEEP((buf), 0)
...
#define BUFV1_MIN_TEXT_X_TO_KEEP(buf)		BUFVX_MIN_TEXT_X_TO_KEEP((buf), 1)
...
#define CEBV_MIN_TEXT_X_TO_KEEP			BUFV_MIN_TEXT_X_TO_KEEP(c_e_b_v)
...
#define CEBV0_MIN_TEXT_X_TO_KEEP		BUFVX_MIN_TEXT_X_TO_KEEP(c_e_b, 0)
...
#define CEBV1_MIN_TEXT_X_TO_KEEP		BUFVX_MIN_TEXT_X_TO_KEEP(c_e_b, 1)
