...
* @brief $B3FB0@-$KCM$r@_Dj$9$k(B
* @param[in] mode_idx($B0z?tL>(B) $B0z?t$N@bL@(B
* @param[in] val($B0z?tL>(B) $B0z?t$N@bL@(B
* @return bool $BLa$jCM$N@bL@(B
* @details $B>\:Y$J@bL@(B
*/
...
#define C_R(func_call, ret)			CMP_RET(func_call, ret)
	...
	C_R(max_wrap_line_idx("$B0lFs;0;M8^O;<7H,6eNm(B", 10), 1)
	C_R(max_wrap_line_idx("$B0lFs;0;M8^O;<7H,6eNm0l(B", 10), 2)
	C_R(max_wrap_line_idx("1$B0lFs;0;M8^O;<7H,6e(B", 10), 1)
	C_R(max_wrap_line_idx("1$B0lFs;0;M8^O;<7H,6eNm(B", 10), 2)
	C_R(max_wrap_line_idx("1$B0lFs;0;M8^(B123456789012", 10), 2)
	...
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 0, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 15, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 15, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 30, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 30, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7H,6eNm0l(B", 45, 10), 2)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 0, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 13, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 13, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 28, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 28, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7H,6eNm0l(B", 43, 10), 4)

	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")-1, 10), 0)
	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B"), 10), 0)
	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+1, 10), 1)
	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+2, 10), 1)
	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B"), 10), 1)
	C_R(start_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B")+1, 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B"), 10), 0)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+1, 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+2, 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B"), 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+1, 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+2, 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B"), 10), 1)
	C_R(start_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B")+1, 10), 1)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")-1, 10), 0)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B"), 10), 0)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+1, 10), 0)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+2, 10), 0)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B"), 10), 0)
	C_R(end_wl_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B")+1, 10), 1)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B"), 10), 0)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+1, 10), 0)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+2, 10), 0)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B"), 10), 0)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+1, 10), 1)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+2, 10), 1)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B"), 10), 1)
	C_R(end_wl_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B")+1, 10), 1)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0(B"), 10), 6)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0(B")+1, 10), 8)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0(B")+2, 10), 8)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B"), 10), 8)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+1, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M(B")+2, 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B"), 10), 0)
	C_R(start_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", strlen("$B0lFs;0;M8^(B")+1, 10), 2)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B"), 10), 7)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+1, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0(B")+2, 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B"), 10), 0)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+1, 10), 2)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M(B")+2, 10), 2)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B"), 10), 2)
	C_R(start_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", strlen("1$B0lFs;0;M8^(B")+1, 10), 4)
	C_R(end_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("$B0lFs;0;M(B"), 10), 8)
	C_R(end_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("$B0lFs;0;M(B")+1, 10), 10)
	C_R(end_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("$B0lFs;0;M(B")+2, 10), 10)
	C_R(end_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, strlen("$B0lFs;0;M8^(B"), 10), 10)
	C_R(end_col_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, strlen("$B0lFs;0;M8^(B")+1, 10), 2)
	C_R(end_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("1$B0lFs;0;M(B"), 10), 9)
	C_R(end_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("1$B0lFs;0;M(B")+1, 10), 2)
	C_R(end_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, strlen("1$B0lFs;0;M(B")+2, 10), 2)
	C_R(end_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, strlen("1$B0lFs;0;M8^(B"), 10), 2)
	C_R(end_col_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, strlen("1$B0lFs;0;M8^(B")+1, 10), 4)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 0, 10), 0)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 7, 10), 12)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 8, 10), 12)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 9, 10), 15)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 10, 10), 15)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 0, 11, 10), 15)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, 0, 10), 15)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, 1, 10), 18)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, 2, 10), 18)
	C_R(start_byte_idx_of_wrap_line("$B0lFs;0;M8^O;<7(B23456789012", 1, 3, 10), 21)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 0, 10), 0)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 7, 10), 10)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 8, 10), 13)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 9, 10), 13)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 10, 10), 13)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 0, 11, 10), 13)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, 0, 10), 13)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, 1, 10), 16)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, 2, 10), 16)
	C_R(start_byte_idx_of_wrap_line("1$B0lFs;0;M8^O;<7(B23456789012", 1, 3, 10), 19)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 0, 0, 10), 0)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 0, 9, 10), 12)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 0, 10, 10), 15)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 0, 11, 10), 15)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 1, 0, 10), 15)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 1, 1, 10), 15)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 1, 2, 10), 18)
	C_R(end_byte_idx_of_wrap_line_le("$B0lFs;0;M8^O;<7(B23456789012", 1, 3, 10), 18)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 0, 0, 10), 0)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 0, 9, 10), 13)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 0, 10, 10), 13)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 0, 11, 10), 13)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 1, 0, 10), 13)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 1, 1, 10), 13)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 1, 2, 10), 16)
	C_R(end_byte_idx_of_wrap_line_le("1$B0lFs;0;M8^O;<7(B23456789012", 1, 3, 10), 16)
}
#endif // START_UP_TEST
...
const char *my_wide_utf8c[WIDE_CHARS] = {
 ...
 "$B"#(B", "$B""(B", "$B"!(B", "$B!~(B", "$B!{(B", "$B!}(B", "$B!|(B", "$B!z(B", "$B!y(B", "", "", "",
 "", "", "", "", "", "", "", "", "", "", "", "", "", "",
 "" };
...
{
#define CL_TAB_EOL	CL_GR	// color for TAB/EOL/"$B!!(B" notation
