...
#ifdef ENABLE_RC
	unsigned char app_RCFILE:1;
#endif // ENABLE_RC
#ifdef ENABLE_HISTORY
	unsigned char app_HISTORY:1;
#endif // ENABLE_HISTORY
	unsigned char app_DRAW_CURSOR:1;
	unsigned char app_UTF8:1;
	unsigned char app_MAP_KEY_7F_BS:1;
...
#define KEY_LINES_MAX			KEY_LINES_3
	unsigned char app_KEY_LINES:2;
#define DEBUG_NONE			0
#define DEBUG_PRINTF		1
	unsigned char app_DEBUG_PRINTF:1;
#define EF_EDITOR				0
#define EF_FILER				1
	unsigned char app_EDITOR_FILER:1;
	...
	unsigned char ed_SHOW_LINE_NUMBER:1;
...
#define CURS_POSITIONING_BOTTOM		3
	unsigned char ed_CURS_POSITIONING:2;
#ifdef ENABLE_SYNTAX
	unsigned char ed_SYNTAX_HIGHLIGHT:1;
	unsigned char ed_TAB_EOL_NOTATION:1;
#endif // ENABLE_SYNTAX
	unsigned char ed_AUTO_INDENT:1;
	unsigned char ed_REVERSE_SEARCH:1;
	unsigned char ed_IGNORE_CASE:1;
#ifdef ENABLE_REGEX
	unsigned char ed_USE_REGEXP:1;
#endif // ENABLE_REGEX
#ifdef USE_NKF
	unsigned char ed_USE_NKF:1;
#endif // USE_NKF
...
#define BACKUP_FILES_MAX		BACKUP_FILES_15
	unsigned char ed_BACKUP_FILES:4;

	// filer settings
	unsigned char fl_SHOW_DOT_FILE:1;
...
#define FILE_SORT_BY_MAX		FILE_SORT_BY_SIZE
	unsigned char fl_FILE_SORT_BY:2;
