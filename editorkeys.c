...
//      12345678901234567890
 ...
 { "TagJump",             "Tagged jump",                    K_F12,        KNA, KNA,
...
#ifdef ENABLE_REGEX
 { "Find Bracket()",      "Find counterpart bracket()",     K_M_LBRACKET, K_M_RBRACKET, K_M_BACKSLASH,
   XL, F_I(doe_find_bracket), NULL },
 { "Find Bracket)(",      "Find counterpart bracket)(",     K_M_LBRACE, K_M_RBRACE, K_M_VERTBAR,
   XL, F_I(doe_find_bracket_reverse), NULL },
/// { "Hilight Bracket()",   "Hilight counterpart bracket()", , KNA, KNA,
