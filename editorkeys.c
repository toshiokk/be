...
////   XL, F_I(doe_pop_cut_buf), NULL },
 { "Copy to clip-board",  "Copy to clip-board",             K_SF07,       KNA, KNA,
   XL, F_I(doe_save_cur_buffer_to_clip_board), NULL },
 { "Paste clip-board",    "Paste clip-board",               K_SF08,       KNA, KNA,
   XL, F_I(doe_read_clip_board_into_cur_pos), NULL },
