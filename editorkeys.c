...
//      12345678901234567890
 ...
 { "Reopen, goto Last pos.", "Reopen and go to Last line",  KNA,          KNA, KNA,
   XL, F_I(doe_reopen_file_last_line), NULL },
 { "Write File as",       "Write file as",                  K_M_s, K_M_S,      KNA,
 ...
 { "TagJump",             "Tagged jump to file or directory", K_F12,        KNA, KNA,
   XA, F_I(doe_goto_file_or_dir_in_cur_line), NULL },
 { "TagJump to directory","Tagged jump to file or directory", K_F11,        KNA, KNA,
 ...
 { "TagJump to directory","Tagged jump to directory",       K_M_J,        KNA, KNA,
   XA, F_I(doe_goto_file_in_cur_cursor_pos), NULL },

 { "",                    "Edit Menu",                      KNA,          KNA, KNA,
   XL, F_I(doe_editor_menu_3), NULL },
 { "Tab",                 "Insert a TAB character",         K_TAB,        KNA, KNA,
   XL, F_I(doe_tab), NULL },
 { "Enter",               "Insert a carriage return",       K_C_M, K_ENTER, K_M_ENTER,
 ...
 { "Playback",            "Playback key-macro",             K_M_2,        KNA, KNA,
   XL, F_I(doe_playback), NULL },
 { "Playback-1",          "Playback 1st newest key-macro",  K_S_F01,       KNA, KNA,
...
////   XL, F_I(doe_pop_cut_buf), NULL },
 ...
 { "UTF-8",               "Toggle Display/Input UTF-8 code",K_MC_U,       KNA, KNA,
   XL, F_I(doe_tog_utf8),           get_str_utf8 },
#endif // ENABLE_UTF8
