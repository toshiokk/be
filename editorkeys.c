...
//      12345678901234567890
 ...
 { "Tag-Jump",            "Tag-jump to file or directory",  K_F12,        KNA, KNA,
   XA, F_I(doe_goto_file_or_dir_in_cur_line), NULL },
 { "Tag-Jump to directory","Tag-jump to file or directory", K_F11,        KNA, KNA,
   XA, F_I(doe_goto_file_or_dir_in_cur_cursor_pos), NULL },
 { "Tag-Jump",            "Tag-jump",                       K_M_j,        KNA, KNA,
   XA, F_I(doe_goto_file_in_cur_line), NULL },
 { "Tag-Jump to directory","Tag-jump to directory",         K_M_J,        KNA, KNA,
