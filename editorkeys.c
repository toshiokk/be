...
//      12345678901234567890
 ...
 { "Reopen, Last L.", "Reopen file and go to Last line",K_M_z,        NKA, NKA,
 ...
 { "Open Files",      "Open files in buffer",           K_M_J,        NKA, NKA,
 ...
 { "TagJump",         "Tagged jump",                    K_M_j, K_F12,      NKA,
   0,F_I(do_goto_file_in_cur_line), NULL },
 ...
 { "End-rec/Playback","End-rec/Playback key-macro",     K_PLB, K_M_l     , NKA,
 ...
 { "Previous File",   "Open previous file",             K_M_COMMA,     NKA, NKA,
   0,F_I(do_switch_to_prev_file), NULL },
 { "Next File",       "Open next file",                 K_M_PERIOD,     NKA, NKA,
   0,F_I(do_switch_to_next_file), NULL },
 ...
 { "Key bindings List","Display Key bindings List",     K_M_F,        NKA, NKA,
   0,F_I(do_switch_to_key_bindings_list), NULL },
#endif // ENABLE_HELP
 { "Open Proj File",  "Open Project file",              K_M_p,        NKA, NKA,
 ...
 { "Tab size",        "Toggle Tab size",                K_M_T,        NKA, NKA,
   0,F_I(do_tog_tab_size),       get_str_tab_size },
 { "Tab size",        "Incurement Tab size",            K_M_Y,        NKA, NKA,
   0,F_I(do_inc_tab_size),       get_str_tab_size },
 { "Draw cursor",     "Toggle Drawing cursor",          K_M_C,        NKA, NKA,
   0,F_I(do_tog_draw_cursor),    get_str_draw_cursor },
 { "Ignore case",     "Toggle Ignore case",             K_M_I,        NKA, NKA,
   0,F_I(do_tog_ignore_case),    get_str_ignore_case },
 { "Auto indent",     "Toggle Auto indent",             K_M_O,        NKA, NKA,
 ...
 { "Back up files",   "Increment Back up files",        K_M_B,        NKA, NKA,
   0,F_I(do_inc_backup_files),   get_str_backup_files },
#ifdef ENABLE_REGEX
 { "RegExp",          "Toggle Regex search/replace",    K_M_X,        NKA, NKA,
   0,F_I(do_tog_regexp),         get_str_regexp },
#endif // ENABLE_REGEX
#ifdef ENABLE_UTF8
 { "UTF-8",           "Toggle Display/Input UTF-8 code",K_M_U,        NKA, NKA,
   0,F_I(do_tog_utf8),           get_str_utf8 },
#endif // ENABLE_UTF8

 { "",                "Settings Menu-2",                K_M_8,        NKA, NKA,
   0,F_I(do_editor_menu_8), NULL },
 { "Cursor center",   "Toggle Cursor-center mode",      K_M_S,        NKA, NKA,
   0,F_I(do_inc_curs_positioning),  get_str_curs_positioning },
 { "Dual scroll",     "Toggle Dual scroll",             K_M_d,        NKA, NKA,
   0,F_I(do_tog_dual_scroll),    get_str_dual_scroll },
 { "View mode",       "Toggle View mode",               K_M_V,        NKA, NKA,
   0,F_I(do_tog_view_mode),      get_str_view_mode },
 { "Show ruler",      "Toggle Show Ruler",              K_M_R,        NKA, NKA,
   0,F_I(do_tog_show_ruler),     get_str_show_ruler },
 { "Show line number","Toggle Show Line number",        K_M_N,        NKA, NKA,
   0,F_I(do_tog_show_line_num),  get_str_show_line_num },
 { "Line-wrap mode",  "Toggle Line-wrap mode",          K_M_L,        NKA, NKA,
   0,F_I(do_tog_line_wrap_mode), get_str_line_wrap_mode },
#ifdef ENABLE_SYNTAX
 { "Syntax HL",       "Toggle Syntax Highlighting",     K_M_H,        NKA, NKA,
   0,F_I(do_tog_syntax_hl),      get_str_syntax_hl },
 { "TAB/EOL notation","Toggle TAB/EOL notation",        K_M_Z,        NKA, NKA,
