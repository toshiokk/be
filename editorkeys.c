...
// 12345678901234567890
 { EFLM_NOEX, "Prev.Menu",           "Previous Menu",
   {K_M_ESC, K_M_BAKQT, KNA}, F_I(doe_editor_menu_0), get_str_setting_none },

 { EFLM_NOEX, "",                    "File Menu",
   {K_ESC,        KNA, KNA},  F_I(doe_editor_menu_0), get_str_setting_none },
 { E_LM_CULN, "Open File",           "Open file",
   {K_M_e,        KNA, KNA},  F_I(doe_open_file), get_str_setting_none },
 { E_LM_CULN, "View File",           "View file (Read-Only)",
 ...
 { EFLM_NOEX, "",                    "Cursor Menu",
   {KNA,          KNA, KNA}, F_I(doe_editor_menu_0), get_str_setting_none },
 ...
 { EFLM_NOEX, "",                    "Edit Menu",
   {KNA,          KNA, KNA}, F_I(doe_editor_menu_0), get_str_setting_none },
 { EFLM_NOEX, "Tab",                 "Insert a TAB character",
 ...
 { EFLM_NOEX, "Backspace",           "Backspace",
   {K_C_H, K_BS,       KNA}, F_I(doe_backspace), get_str_setting_none },
 { EFLM_NOEX, "Backspace(limited)",   "Backspace(limited)",
   {K_MC_H,       KNA, KNA}, F_I(doe_backspace_limited), get_str_setting_none },
 { EFLM_NOEX, "Delete",              "Delete a character",
   {K_C_G, K_DEL,      KNA}, F_I(doe_delete_char), get_str_setting_none },
 { EFLM_NOEX, "UpperLower",          "Invert upper/lower letter",
   {K_C_W,        KNA, KNA}, F_I(doe_conv_upp_low_letter), get_str_setting_none },
 { EFLM_NOEX, "UpperLetter",         "Make upper letter",
   {K_MC_U,       KNA, KNA}, F_I(doe_conv_low_letter), get_str_setting_none },
 { EFLM_NOEX, "Ctrl code",           "Input control code",
   {K_M_EXCLA,    KNA, KNA}, F_I(doe_control_code), get_str_setting_none },
 { EFLM_NOEX, "Char code",           "Input character code",
   {K_M_AT,       KNA, KNA}, F_I(doe_charcode), get_str_setting_none },
 { EFLM_NOEX, "Memorize column pos.","Memorize column position",
   {K_M_LPARE,    KNA, KNA}, F_I(doe_memorize_columns), get_str_setting_none },
 { EFLM_NOEX, "Fill spaces",         "Fill spaces till the columns",
   {K_M_RPARE,    KNA, KNA}, F_I(doe_fill_spaces_to_columns), get_str_setting_none },
 { EFLM_NOEX, "Paste history",       "Paste from history",
 ...
 { EFLM_NOEX, "Replace",             "Replace keyword",
   {K_C_CARET,    KNA, KNA}, F_I(doe_replace), get_str_setting_none },
#ifdef ENABLE_REGEX
 { EFLM_NOEX, "Find Bracket()",      "Find counter bracket()",
 ...
 { EFLM_NOEX, "Top File",            "Switch to top file",
   {K_M_LESST,    KNA, KNA}, F_I(doe_switch_to_top_buffer), get_str_setting_none },
 { EFLM_NOEX, "Bottom File",         "Switch to bottom file",
 ...
 { EFAM_EXEC, "Previous buffers",    "Switch to previous buffers",
   {K_M_LBRAC,    KNA, KNA}, F_I(doe_switch_to_prev_buffers), get_str_setting_none },
 { EFAM_EXEC, "Next buffers",        "Switch to next buffers",
   {K_M_RBRAC,    KNA, KNA}, F_I(doe_switch_to_next_buffers), get_str_setting_none },
 { EFLM_NOEX, "Open project file",   "Open project file",
   {K_M_P,        KNA, KNA}, F_I(doe_open_proj_file), get_str_setting_none },
 { EFLM_NOEX, "Open execution log file", "Open exec. log file",
   {K_M_l,        KNA, KNA}, F_I(doe_open_exec_log_file), get_str_setting_none },
 { EFLM_NOEX, "Goto prev. pos",      "Goto previous pos.",
